...
class Subscription {
  ...
  send(data) {
    this.handler.core.broadcastUser(
      this.username,
      'osjs/wireless-tools:subscription',
      this.id,
      data
    );
  }
...
class Subscriptions {
  ...
  add(id, username, ns, method, args) {
    console.debug('@osjs/wireless-tools-provider', 'Subscriptions#add', {
  ...
  remove(id) {
    console.debug('@osjs/wireless-tools-provider', 'Subscriptions#remove', id);
  ...
  attach(id, ws) {
    console.debug('@osjs/wireless-tools-provider', 'Subscriptions#attach', id);
...
class WirelessToolsServiceProvider {
  ...
  start() {
    this.core.on('osjs/wireless-tools:subscription:attach', (ws, id) => {
